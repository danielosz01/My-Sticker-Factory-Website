...
export const ADMIN_SUB_PRODUCT_REQUEST = "ADMIN_PRODUCT_REQUEST";
export const ADMIN_SUB_PRODUCT_SUCCESS = "ADMIN_PRODUCT_SUCCESS";
export const ADMIN_SUB_PRODUCT_FAIL = "ADMIN_PRODUCT_FAIL";
